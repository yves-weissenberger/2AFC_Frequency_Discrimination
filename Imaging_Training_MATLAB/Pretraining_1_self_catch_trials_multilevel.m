...
trl_order = Shuffle([0,4,6,7,8,8.5,9,10,11,99,0,4,6,7,8,8.5,9,10,11,99])';
...
%     trl_order = cat(1,trl_order, Shuffle([8,9,8,9,8,9,8,9,8,9,8,9,8,9,8,9]-2)');
    ...
    trl_order = cat(1,trl_order,Shuffle([0,4,6,7,8,8.5,9,10,11,99,0,4,6,7,8,8.5,9,10,11,99])');
