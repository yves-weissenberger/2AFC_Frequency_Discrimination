...
% load C:\Users\win-ajk009-admin\Documents\MATLAB\snd_tone_13k.mat
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
centreFreq = f_span(2);
frqs = [8000*(2^-.75),8000*(2^.75)];%Johannes
i = 1;
sndMat = cell(1);
...
%             snd = click;%click/(2^1);Johannes
            
            [snd, vol, frq] = get_stim_J(2,frqs,centreFreq,params,callibration_functions,'ThreeByThree');%Johannes
            ...
            fprintf(fileID,strcat('Sound:',num2str(round(frq)),'_',num2str(2), ...
                num2str(sndT),'_', ...
                num2str(frame_Nr),'\n'));
